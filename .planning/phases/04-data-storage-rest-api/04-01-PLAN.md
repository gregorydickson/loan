...
must_haves:
  truths:
    ...
    - "BorrowerRepository retrieves borrowers by ID with all relationships loaded"
...
Run: `cd /Users/gregorydickson/stackpoint/loan/backend && python -m pytest tests/unit/test_borrower_repository.py -v --tb=short`
  ...
  <done>All 8 test cases pass, tests cover create, get, search, list, and count operations</done>
</task>
...
- All methods use `selectinload()` for eager loading relationships
