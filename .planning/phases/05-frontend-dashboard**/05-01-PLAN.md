...
<task type="auto">
  ...
  <action>
    ...
    - Welcome message and quick stats cards
    - Links to Documents and Borrowers sections
  ...
  <done>App shell renders with sidebar navigation and QueryClientProvider wrapper</done>
</task>
...
3. Clicking sidebar links navigates (pages may show 404 until created)
4. No console errors about QueryClient
5. `npx tsc --noEmit` passes in frontend directory
</verification>
